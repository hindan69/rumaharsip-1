...
<body>
    ...
    <main class="main" id="top">
        <div class="container-fluid bg-body-tertiary dark__bg-gray-1200">
            <div class="bg-holder bg-auth-card-overlay" style="background-image:url(<?= base_url(); ?>Phoenix/assets/img/bg/37.png);">
            </div>
            <!--/.bg-holder-->
                        ...
                        <div class="card-body pe-md-0">
                            <div class="row align-items-center gx-0 gy-7">
                                <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                                    <div class="bg-holder" style="background-image:url(<?= base_url(); ?>Phoenix/assets/img/bg/38.png);">
                                    </div>
                                    <!--/.bg-holder-->

                                    <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7 pb-md-7">
                                        <h3 class="mb-3 text-body-emphasis fs-7">Rumah Arsip</h3>
                                        <p class="text-body-tertiary">Inspektorat Jenderal</p>
                                    ...
                                    <div class="position-relative z-n1 mb-6 d-none d-md-block text-center mt-md-15"><img class="auth-title-box-img d-dark-none" src="<?= base_url(); ?>Phoenix/assets/img/spot-illustrations/auth.png" alt="" /><img class="auth-title-box-img d-light-none" src="<?= base_url(); ?>Phoenix/assets/img/spot-illustrations/auth-dark.png" alt="" /></div>
                                </div>
                                <div class="col mx-auto">
                                    <div class="auth-form-box">
                                        <div class="text-center mb-7"><a class="d-flex flex-center text-decoration-none mb-4" href="<?= base_url(); ?>Phoenix/index.html">
                                                <div class="d-flex align-items-center fw-bolder fs-3 d-inline-block"><img src="<?= base_url(); ?>Phoenix/assets/img/icons/logo.png" alt="phoenix" width="58" />
                                                </div>
                                            </a>
                                            <h3 class="text-body-highlight">RUMAH ARSIP</h3>
                                        ...
                                        <form action="<?= base_url(); ?>loginprocess" method="post">
                                            ...
                                            <div class="mb-3 text-start">
                                                ...
                                                <div class="form-icon-container">
                                                    <input class="form-control form-icon-input" id="NIP" name="NIP" type="text" placeholder="NIP / Username" required /><span class="fas fa-user text-body fs-9 form-icon"></span>
                                                </div>
                                            </div>
                                            <div class="mb-3 text-start">
                                                <label class="form-label" for="password">Password</label>
                                                <div class="form-icon-container" data-password="data-password">
                                                    <input class="form-control form-icon-input pe-6" id="password" name="password" type="password" required placeholder="Password" data-password-input="data-password-input" /><span class="fas fa-key text-body fs-9 form-icon"></span>
                                            ...
                                            <div class="row flex-between-center mb-7">
                                                ...
                                                <div class="col-auto"><a class="fs-9 fw-semibold" href="<?= base_url(); ?>">Forgot Password?</a></div>
                                            </div>
                                            <button class="btn btn-primary w-100 mb-3">Sign In</button>

                                            <!-- <div class="text-center"><a class="fs-9 fw-bold" href="<?= base_url(); ?>Phoenix/pages/authentication/card/sign-up.html">Create an account</a></div> -->
                                        </form>
                                    </div>
                                </div>
                            </div>
